            ...
            <li className="my-4">
              <div className="grid grid-cols-1 md:grid-cols-6 gap-2">
                <span className="md:col-span-4">
                  <p>4. The <i>Town&apos;s Objectives</i> are based on the number of villagers and their roles.</p>
                  ...
                  <ol className="list-disc ml-8">
                    ...
                    <li>Finish building the Hospital (activates the Doctor&apos;s Power)</li>
                    <li>Finish building the Watch Tower (activates the Guard&apos;s Power)</li>
                    <li>Finish building the Constable&apos;s Station (activates the Constable&apos;s Power)</li>
        ...
        <div className="mt-8 leading-2 p-2 sm:p-4 mx-1 md:mx-4">
          ...
          <div className="mt-12">
            ...
            <ol className="mt-4 list-decimal ml-4 leading-8 ml-4">
              ...
              <li>A Level 3 demon can attack twice during the night, two different targets once, or </li>
            </ol>
